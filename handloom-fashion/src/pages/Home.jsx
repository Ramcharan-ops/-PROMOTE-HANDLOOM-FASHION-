    ...
    >
      ...
      <div
        style={{
          ...
          right: 0,
          bottom: 0,
          backgroundColor: 'rgba(13, 214, 13, 0.5)',
          zIndex: 0
        }}
      ></div>
      {/* 🌸 Main content */}
      <div style={{ position: 'relative', zIndex: 1 }}>
        <h1 style={{ fontSize: '3.5rem', marginBottom: '20px', fontWeight: 'bold' }}>
          Welcome to <span style={{ color: '#bdbdbdff' }}>Handloom Fashion</span>
        </h1>
        <p
          style={{
            fontSize: '1.25rem',
        ...
        >
          {/* Product 1 */}
          <div className="image-card" style={{ borderRadius: '12px', overflow: 'hidden', boxShadow: '0 6px 12px rgba(221, 0, 0, 0.2)', backgroundColor: '#fff', color: '#000000ff' }}>
            ...
            <h3 style={{ margin: '12px 0', color: '#2f4f4f', fontSize: '1.1rem' }}>Elegant Cotton Saree</h3>
          </div>
          {/* Product 2 */}
          <div className="image-card" style={{ borderRadius: '12px', overflow: 'hidden', boxShadow: '0 6px 12px rgba(0, 0, 0, 0.2)', backgroundColor: '#fff', color: '#000000ff' }}>
            ...
            <h3 style={{ margin: '12px 0', color: '#2f4f40ff', fontSize: '1.1rem' }}>Handwoven Silk Scarf</h3>
          </div>
          {/* Product 3 */}
          <div className="image-card" style={{ borderRadius: '12px', overflow: 'hidden', boxShadow: '0 6px 12px rgba(0, 0, 0, 0.2)', backgroundColor: '#fff', color: '#000' }}>
            ...
            <h3 style={{ margin: '12px 0', color: '#2f4f4f', fontSize: '1.1rem' }}>Woolen Shawl Collection</h3>
          </div>
          {/* Product 4 */}
          <div className="image-card" style={{ borderRadius: '12px', overflow: 'hidden', boxShadow: '0 6px 12px rgba(0,0,0,0.2)', backgroundColor: '#fff', color: '#000' }}>
            ...
            <h3 style={{ margin: '12px 0', color: '#2f4f4f', fontSize: '1.1rem' }}>Traditional Handloom Craft</h3>
          </div>
         {/* Product 5 */}
          <div className="image-card" style={{ borderRadius: '12px', overflow: 'hidden', boxShadow: '0 6px 12px rgba(0,0,0,0.2)', backgroundColor: '#fff', color: '#000' }}>
            ...
            <h3 style={{ margin: '12px 0', color: '#2f4f4f', fontSize: '1.1rem' }}>Wedding Collections</h3>
          </div>
 {/* Product 6 */}
          <div className="image-card" style={{ borderRadius: '12px', overflow: 'hidden', boxShadow: '0 6px 12px rgba(0,0,0,0.2)', backgroundColor: '#fff', color: '#000' }}>
            ...
            <h3 style={{ margin: '12px 0', color: '#2f4f4f', fontSize: '1.1rem' }}>Pattu Saree</h3>
          </div>
          {/* Product 7 */}
          <div className="image-card" style={{ borderRadius: '12px', overflow: 'hidden', boxShadow: '0 6px 12px rgba(0,0,0,0.2)', backgroundColor: '#fff', color: '#000' }}>
            ...
            <h3 style={{ margin: '12px 0', color: '#2f4f4f', fontSize: '1.1rem' }}>Banarasi Silk Saree</h3>
          </div>
          {/* Product 8 */}
          <div className="image-card" style={{ borderRadius: '12px', overflow: 'hidden', boxShadow: '0 6px 12px rgba(0,0,0,0.2)', backgroundColor: '#fff', color: '#000' }}>
            ...
            <h3 style={{ margin: '12px 0', color: '#2f4f4f', fontSize: '1.1rem' }}>Wedding Kanjivaram Saree</h3>
          </div>
          {/* Product 9 */}
          <div className="image-card" style={{ borderRadius: '12px', overflow: 'hidden', boxShadow: '0 6px 12px rgba(0,0,0,0.2)', backgroundColor: '#fff', color: '#000' }}>
            ...
            <h3 style={{ margin: '12px 0', color: '#2f4f4f', fontSize: '1.1rem' }}>Tissue Saree</h3>
          </div>
          {/* Product 10 */}
          <div className="image-card" style={{ borderRadius: '12px', overflow: 'hidden', boxShadow: '0 6px 12px rgba(0, 0, 0, 0.2)', backgroundColor: '#fff', color: '#000' }}>
            ...
            <h3 style={{ margin: '12px 0', color: '#2f4f4f', fontSize: '1.1rem' }}>Indo Western Saree</h3>
          </div>
        </div>
        <p style={{ marginTop: '50px', fontSize: '1.4rem', fontWeight: '500' }}>
